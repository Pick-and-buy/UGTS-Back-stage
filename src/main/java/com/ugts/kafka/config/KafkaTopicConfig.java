...
public class KafkaTopicConfig {
    ...
    public NewTopic notificationTopic(){
        return TopicBuilder
                .name(AppConstant.GENERAL_NOTIFICATION_TOPIC)
                .build();
    }
    ...
    public NewTopic postTopic(){
        return TopicBuilder
                .name(AppConstant.POST_RELATED_TOPIC)
                .build();
    }
    ...
    public NewTopic followsTopic(){
        return TopicBuilder
                .name(AppConstant.FOLLOW_RELATED_TOPIC)
                .build();
    }
    ...
    public NewTopic buyingTopic(){
        return TopicBuilder
                .name(AppConstant.BUYING_RELATED_TOPIC)
                .build();
    }
}
