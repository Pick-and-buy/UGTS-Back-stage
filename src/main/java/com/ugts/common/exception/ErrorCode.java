package com.ugts.common.exception;
...
public enum ErrorCode {
    ...
    CANNOT_FOLLOW_YOURSELF(1018, "Cannot follow yourself", HttpStatus.BAD_REQUEST),
    ...
    POST_NOT_AVAILABLE(1007, "Post not available", HttpStatus.BAD_REQUEST),
